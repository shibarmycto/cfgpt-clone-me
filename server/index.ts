...
function configureExpoAndLanding(app: express.Application) {
  ...
  if (hasWebBuild) {
    app.use("/assets", express.static(path.join(webBuildDir, "assets")));
    app.use("/_expo", express.static(path.join(webBuildDir, "_expo"), { maxAge: "1y", immutable: true }));
    app.use("/favicon.ico", express.static(path.join(webBuildDir, "favicon.ico")));
  }
